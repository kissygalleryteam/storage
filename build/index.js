 ...
 *
 * @see 整体方案设计 //work.tmall.net/projects/tbar/wiki/Storage
 * @see postMessage https://developer.mozilla.org/en-US/docs/Web/API/window.postMessage
 * @see js onload //www.planabc.net/2008/10/31/javascript_ready_onload/
 */
KISSY.add('gallery/storage/1.1/index', function(S, Event, JSON, Conf, U, XD) {
    ...
    S.augment(Storage, {
        init: function() {
            ...
            // @see iframe onload //www.planabc.net/2009/09/22/iframe_onload/
