...
kg/storage/3.0.0/conf
kg/storage/3.0.0/util
kg/storage/3.0.0/xd
kg/storage/3.0.0/basic
kg/storage/3.0.0/proxy
...
KISSY.add('gallery/storage/1.1/conf', function() {
    ...
    var arr = '//gm.mmstat.com'; // log.mmstat.com
    var MINER = '//log.mmstat.com/ued.1.1.2?type=9&_gm:id=storage&v=1.1';
    ...
    var Conf = {
        ...
        PROXY: '//www.tmall.com/go/act/stp-tm.php',
        PROXY_TMALL: '//www.tmall.com/go/act/stp-tm.php',
        PROXY_TAOBAO: '//www.taobao.com/go/act/stp-tb.php',
        // 用于标识 xd 实例
...
KISSY.add('gallery/storage/1.1/xd', function(S, Event, JSON, Conf, U) {
    ...
    function messageHandler(ev) {
        ...
        // TODO 安全考虑 if(ev.origin == '//www.tmall.com'){}
    ...
    S.augment(XD, {
        ...
        send: function(action, origin, noResponse) {
            ...
            if (me.get(IFRAME_TIMEOUT)) {
                ...
                if (postMessage) {
                    // @see //dev.w3.org/html5/postmsg/#dom-window-postmessage
...
KISSY.add('gallery/storage/1.1/basic', function(S, JSON) {
    ...
    (function(win) {
        ...
        if (isLocalStorageNameSupported()) {
            ...
            // (see: //msdn.microsoft.com/en-us/library/aa752574(v=VS.85).aspx)
            ...
            function withIEStorage(storeFunction) {
                return function() {
                    ...
                    try {
                        ...
                        // See //msdn.microsoft.com/en-us/library/ms531081(v=VS.85).aspx
                        // and //msdn.microsoft.com/en-us/library/ms531424(v=VS.85).aspx
