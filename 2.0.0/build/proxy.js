...
kg/storage/2.0.0/xd
kg/storage/2.0.0/basic
kg/storage/2.0.0/proxy
 ...
 *
 */
KISSY.add('kg/storage/2.0.0/xd', function(S, Event, JSON, Conf, U) {
    var guid = 0;
 ...
 */
KISSY.add('kg/storage/2.0.0/basic', function(S, JSON) {
 ...
 * @author luics (鬼道)
 */
KISSY.add('kg/storage/2.0.0/proxy', function(S, Event, JSON, XD, Storejs, Conf, U) {
    var Proxy = {};
